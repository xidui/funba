...
# Defunct franchises that never became part of a current NBA team.
# These 1940s BAA / early-NBA teams folded and were not absorbed into any
# surviving franchise. They are kept separate from FRANCHISE_HISTORY because
# their `team_id` points to a legacy Team row (is_legacy=True), not one of
# the 30 current NBA team_ids.
#
# Schema matches FRANCHISE_HISTORY eras, but all entries are defunct
# (year_end is never None). Coordinates use the city center.
DEFUNCT_FRANCHISES = [
    {
        "team_id": "1610610023",
        "franchise": "Packers",
        "era_name": "Anderson Packers",
        "abbr": "AND",
        "city": "Anderson",
        "state": "IN",
        "year_start": 1949,
        ...
        "lat": 40.1053,
        "lon": -85.6803,
        "note": "One NBA season (1949-50) after playing in the NBL since 1946.",
    },
    {
        "team_id": "1610610024",
        "franchise": "Bullets",
        ...
        "lat": 39.2904,
        "lon": -76.6122,
        "note": "Original Baltimore Bullets (1947-54). Unrelated to the modern Wizards franchise.",
    },
    {
        "team_id": "1610610025",
        "franchise": "Stags",
        "era_name": "Chicago Stags",
        "abbr": "CHS",
        "city": "Chicago",
        "state": "IL",
        "year_start": 1946,
    ...
    },
    {
        "team_id": "1610610030",
        "franchise": "Olympians",
        "era_name": "Indianapolis Olympians",
        "abbr": "INO",
        "city": "Indianapolis",
        "state": "IN",
        "year_start": 1949,
    ...
    },
    {
        ...
        "era_name": "Providence Steamrollers",
        "abbr": "PRO",
        "city": "Providence",
        "state": "RI",
        "year_start": 1946,
