...
def _build_game_analysis_description(target_date: date, game_id: str) -> str:
    ...
    return (
        ...
        "5. End each post with 6-8 metric / page links. Every metric or page mentioned in the body should appear in that ending section.\n"
        "6. Leave the resulting posts in Funba in `ai_review` so the Content Reviewer agent can audit them before human review.\n"
