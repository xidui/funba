...
def _metric_page_adjustments(*, top_n: int = 5) -> dict[str, object]:
    return {
        "remove_selectors": _COMMON_CHROME_REMOVE_SELECTORS + [
            ".detail-back",
            ".detail-meta a[href*='/metrics/'][href*='/edit']",
            ".detail-meta a[href*='/auth/google']",
            ".detail-meta a[href*='/login']",
            ".detail-meta a[href*='/pricing']",
            ".metric-switch",
            ".season-select",
            "#backfill-panel",
            "#admin-details-drawer",
            "#metric-latency-panel",
            "#toggle-metric-enabled-btn",
            "#metric-deep-dive-trigger",
            "#metric-deep-dive-open",
            ".detail-meta button[onclick*='admin-details-drawer']",
