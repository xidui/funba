...
class Team(Base):
    ...
    general_manager = Column(String(100), nullable=True)
    head_coach = Column(String(100), nullable=True)
    g_league_affiliation = Column(String(100), nullable=True)
...
class Game(Base):
    ...
    tipoff_time = Column(String(32), nullable=True)
    external_game_code = Column(String(32), nullable=True)
    national_tv_broadcaster = Column(String(32), nullable=True)
